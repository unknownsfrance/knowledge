...
class TechnologiesControllerTest < ActionController::TestCase
  ...
  test "should create technology" do
    assert_difference('Technology.count') do
      post :create, technology: { description: @technology.description, files: @technology.files, name: @technology.name, tags: @technology.tags, url: @technology.url }
    end
  ...
  test "should update technology" do
    patch :update, id: @technology, technology: { description: @technology.description, files: @technology.files, name: @technology.name, tags: @technology.tags, url: @technology.url }
    assert_redirected_to technology_path(assigns(:technology))
  end
